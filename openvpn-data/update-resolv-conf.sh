#!/usr/bin/env bash
# From: https://github.com/alfredopalhares/openvpn-update-resolv-conf/blob/master/update-resolv-conf.sh
#
...
echo "=== Applying pushed DHCP options ==="
...
"
  ...
  ;;
down)
  echo "Restoring DNS nameservers"
